<template>
  ...
  >
    <defs>
      <linearGradient id="gradient-social" gradientTransform="rotate(90)">
        <stop offset="0%" stop-color="#1f2937" />
        <stop :offset="`${getSocialPercent}%`" stop-color="#1f2937" />
        <stop :offset="`${getSocialPercent}%`" stop-color="#15803d" />
...
const { getSocialPercent } = useCharacter()
</script>
